...
$parallaxSubtitle = "Masonry Shop List + Sidebar";
include('../partials/geo-parallax.php');
?>

<div class="geo-shoplist geo-shoplist-masonry geo-shoplist-withsidebar">
	<div class="container">
		...
		<div class="geo-content-area">
			...
			<a href="#" class="show-more">Show more 15 <span>(158)</span></a>
