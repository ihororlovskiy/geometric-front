					...
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="/img/shop/item-01-small.jpg">
								<img src="/img/shop/item-01-big.jpg" data-action="zoom">
							</li>
							<li data-thumb="/img/shop/item-02-small.jpg">
								<img src="/img/shop/item-02-big.jpg" data-action="zoom">
							</li>
							<li data-thumb="/img/shop/item-03-small.jpg">
								<img src="/img/shop/item-03-big.jpg" data-action="zoom">
							</li>
							<li data-thumb="/img/shop/item-04-small.jpg">
								<img src="/img/shop/item-04-big.jpg" data-action="zoom">
							</li>
						</ul>
					</div>
				</section> -->
			...
			<div class="col-sm-6">
					...
					<!-- <div class="size">
						...
						<form action="">
							...
							<input type="radio" name="sex" value="S"><span>S</span>
							<input type="radio" name="sex" value="M"><span>M</span>
							<input type="radio" name="sex" value="L"><span>L</span>
