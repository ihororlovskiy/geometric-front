...
<div class="geo-header-section">
  <div class="geo-feature-title">
    ...
    <div class="geo-page-subtitle">Mansory Portfolio</div>
  </div>
  <div class="geo-pattern"></div>
  <div class="geo-bg-image" style="background-image: url(/img/image-2.jpg);"></div>
</div>

<div class="geo-portfolio-list geo-portfolio-list-grid geo-portfolio-list-grid-2-col">
    ...
    <div class="geo-content-area">
      ...
      <div class="clearfix">
        ...
        <article class="photography art " data-category="photography">
          <img src="/img/portfolio-grid-04.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="business photography " data-category="business">
          <img src="/img/portfolio-grid-05.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-06.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-07.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-08.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-09.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-10.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
        ...
        <article class="art " data-category="art">
          <img src="/img/portfolio-grid-11.jpg" alt="portfolio" />
          <div class="fx-layout">
            <span>
              <i>
                <a href="#" class="geo-btn geo-btn-primary">Read More</a>
