...
$parallaxSubtitle = "Classic Portfolio (4 Columns)";
include('../partials/geo-parallax.php');
?>

<div class="geo-portfolio-list geo-portfolio-list-classic geo-portfolio-list-classic-4-col">
	<div class="container">
		<div class="geo-content-area">
			...
			<div class="geo-portfolio-isotope-fitrows clearfix">
				...
				<article class="art " data-category="art">
					<img src="/img/portfolio-classic-1.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
				...
				<article class="business " data-category="business">
					<img src="/img/portfolio-classic-2.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="fashion art photography " data-category="fashion">
					<img src="/img/portfolio-classic-3.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="photography art " data-category="photography">
					<img src="/img/portfolio-classic-4.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="business photography " data-category="business">
					<img src="/img/portfolio-classic-5.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="art " data-category="art">
					<img src="/img/portfolio-classic-6.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="business " data-category="business">
					<img src="/img/portfolio-classic-7.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="fashion art photography " data-category="fashion">
					<img src="/img/portfolio-classic-8.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
				...
				<article class="photography art " data-category="photography">
					<img src="/img/portfolio-classic-9.jpg" alt="portfolio" />
					<div class="fx-layout">
						<span>
							<i>
								<a href="#" class="geo-btn geo-btn-primary">Read More</a>
